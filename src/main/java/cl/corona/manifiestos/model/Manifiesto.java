...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = "MNFST_PEND", procedureName = "PMM_MNFST_PENDIENTES", parameters = {
...
public class Manifiesto {
    ...
    public Manifiesto(int id, int id_origen, int lista_carga, Date fecha_ingreso, Date fecha_emision, int tot_lpn, int tot_uni, Date fecha_recepcion, int destino, String desc_zona, String estado, String mnfst) {
        this.id = id;
