...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = "MNFST_PEND_DAY", procedureName = "PMM_MNFST_PENDIENTES_SEM_TAT", parameters = {
                @StoredProcedureParameter(mode = ParameterMode.REF_CURSOR, name = "C1", type = Class.class)})})

public class ManifiestoDay {
    ...
    public ManifiestoDay()  {
        super();
    }

    public ManifiestoDay(int id, int id_origen, int lista_carga, Date fecha_ingreso, Date fecha_emision, int tot_lpn, int tot_uni, Date fecha_recepcion, int destino, String desc_zona, String estado, String mnfst) {
        this.id = id;
